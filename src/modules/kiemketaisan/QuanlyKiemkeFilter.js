...
import { trangThaiKiemke } from '../../api/config';
            ...
            <View style={styles.container}>
                ...
                <>
                    <View>
                        ...
                        <MultiSelect
                            ref={trangThaiRef}
                            onToggleList={() => closeMultiSelectIfOpened(filterType.trang_thai_kiem_ke)}
...
export default connect(mapStateToProps)(QuanLyKiemkeFilterComponent);